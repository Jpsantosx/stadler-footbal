...
export function athleteFabricMaterial(color:string,source:THREE.MeshPhysicalMaterial,normalStrength=.48){
 return new THREE.MeshPhysicalMaterial({
  color,normalMap:source.normalMap,normalScale:new THREE.Vector2(normalStrength,normalStrength),
  roughnessMap:source.roughnessMap,roughness:.94,sheen:.5,sheenRoughness:.88,
